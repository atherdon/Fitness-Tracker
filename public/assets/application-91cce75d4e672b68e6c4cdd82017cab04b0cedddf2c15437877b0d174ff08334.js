...
$('.add-after-stats').click ->
  ...
  $(wrapper).on 'click', '.remove_field', (e) ->
    ...
    return
  return
$('#cancel-before-stats').click ->
  $('#before-partial').hide()
  $('.add-before-stats').show()
  return
$('#cancel-after-stats').click ->
  $('#after-partial').hide()
  $('.add-after-stats').show()
  return
$('.edit-before-stats-button').click ->
  ...
  $(wrapper).on 'click', '.remove_field', (e) ->
    ...
    return
  return
$('#cancel-edit-before-stats').click ->
  $('#edit-before-partial').hide()
  $('.edit-before-stats').show()
  return
$('.edit-after-stats-button').click ->
