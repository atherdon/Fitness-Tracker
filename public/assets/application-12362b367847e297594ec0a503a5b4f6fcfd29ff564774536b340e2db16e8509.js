...
$(document).on("propertychange change click keyup input paste", "#sets", function() {
   var elem = $(this);
   ...
   elem.bind("propertychange change click keyup input paste", function(event){
      ...
      if (elem.data('oldVal') != elem.val()) {
       ...
       for(i = 0; i < elem.val(); i++) { 
			  $(wrapper).append('<div class="sets-fields"><input type="text" style="width: 80px" name="weight[]" placeholder="Weight"/>'+
		  '<input type="text" style="width: 80px" name="reps[]" placeholder="Reps"/></div>');
			}
...
// this is the event that is fired when a user clicks on a suggestion
	$('.typeahead').bind('typeahead:selected', function(event, datum, name) {
		...
		$(wrapper).append('<div class="'+name+'">'+
				...
				'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input disabled="disabled" class="exercise-name" type="text" style="width: 258px" name="exercise[]" value="'+name+'"/>'+
	    ...
	    $(wrapper).append(
	    	'<input type="text" style="width: 56px" name="'+name+'-sets[]" placeholder="Sets" id="sets"/>'+
			  '<input type="text" style="width: 56px" name="'+name+'-reps[]" placeholder="Reps"/><br>');
		});
